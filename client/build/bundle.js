	...
	var CountriesBox = React.createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.state.currentCountry) {
	            countryDisplay = React.createElement(CountryDisplay, { country: this.state.currentCountry, countries: this.state.countries, onSelectCountry: this.setCurrentCountry });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountriesSelect = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var createOption = function createOption(country, index) {
	            return React.createElement(
	                'option',
	                {
	                    value: index,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BorderingCountriesDisplay = __webpack_require__(162);
	
	var CountryDisplay = React.createClass({
	    displayName: 'CountryDisplay',
	
	
	    findBorderingCountries: function findBorderingCountries(myCountry) {
	    ...
	    render: function render() {
	        ...
	        if (country.borders.length !== 0) {
	            borderingCountriesDisplay = React.createElement(BorderingCountriesDisplay, { countries: this.findBorderingCountries(country), onSelectCountry: this.props.onSelectCountry });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BorderingCountriesDisplay = React.createClass({
	    displayName: 'BorderingCountriesDisplay',
	    ...
	    render: function render() {
	        var createButtons = function (country, index) {
	            return React.createElement(
	                'button',
	                { value: index, key: index, onClick: this.handleClick },
	                country.name
	            );
	        }.bind(this);
